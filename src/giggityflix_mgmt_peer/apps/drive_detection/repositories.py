...
from giggityflix_mgmt_peer.apps.drive_detection.transformers import (
...
class DriveRepository:
    ...
    @classmethod
    def get_all_drives(cls) -> List[DomainDrive]:
        """
    ...
    @classmethod
    def get_drive_by_id(cls, drive_id: str) -> Optional[DomainDrive]:
        """
        Get a drive by ID.
    ...
    @classmethod
    def get_drive_mapping(cls) -> DriveMapping:
        """
    ...
    @classmethod
    @transaction.atomic
    def save_drive(cls, drive: DomainDrive) -> str:
        """
    ...
    @classmethod
    @transaction.atomic
    def save_drive_mapping(cls, drive_mapping: DriveMapping) -> None:
        """

...
from giggityflix_mgmt_peer.apps.drive_detection.repositories import DriveRepository
...
class DriveService:
    ...
    def detect_and_persist_drives() -> Dict[str, int]:
        ...
        DriveRepository.clear_all_drives()
        ...
        DriveRepository.save_drive_mapping(drive_mapping)
    ...
    @staticmethod
    def get_all_drives() -> List[PhysicalDrive]:
        """
        ...
        """
        return DriveRepository.get_all_drives()
    ...
    def get_drive_mapping() -> DriveMapping:
        ...
        """
        return DriveRepository.get_drive_mapping()
